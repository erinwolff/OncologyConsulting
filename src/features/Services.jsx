      ...
      <Card
        ...
        <Tabs
          ...
          <TabPanels>
            ...
            <TabPanel>
              <UnorderedList>
                <ListItem><Text>Didactic lectures for specific oncology indications, response definitions, drug classes, clinical trial best practice, and basics in biostatistics will be provided specifically tailored to the customers needs.</Text></ListItem>
                <br />
                <ListItem><Text>Mentoring of junior employees, in particular medical and safety directors will be provided on scheduled one on one video conference basis, as well as providing resources, and out of schedule point of contact support.</Text></ListItem>
                <br />
                <ListItem><Text>Coaching of senior employees, focusing on senior medical doctors switching to the industry on senior levels will be provided as a structured process over a predetermined time period.  This may include an initial assessment of issues that may have occurred, personal meetings, a coaching plan, scheduled one on one video conference basis, and out of schedule point of contact support, a midterm coaching assessment, and a final project conclusion.</Text></ListItem>
              </UnorderedList>
              <br />
              <Center>
